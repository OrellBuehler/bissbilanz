<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default:
					'bg-gradient-to-r from-primary-container to-primary text-primary-foreground hover:from-primary-container/90 hover:to-primary/90 shadow-none rounded-full',
				destructive:
					'bg-destructive hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 text-white shadow-xs',
				outline:
					'bg-background hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 border border-outline-variant/15 shadow-none',
				secondary:
					'bg-surface-container-high text-secondary-foreground hover:bg-surface-container-highest shadow-none',
