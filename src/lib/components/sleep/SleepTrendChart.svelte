...
<div class="space-y-3">
	...
	{#if hasData}
		<div
			class="relative overflow-hidden rounded-xl border border-purple-200/60 bg-gradient-to-b from-purple-50/80 via-purple-50/20 to-background p-1 dark:border-purple-900/40 dark:from-purple-950/25 dark:via-purple-950/10"
		>
