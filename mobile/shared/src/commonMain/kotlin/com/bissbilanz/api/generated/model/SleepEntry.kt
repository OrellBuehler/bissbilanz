...
data class SleepEntry(
    ...
    @SerialName(value = "sleepLatencyMinutes") @Required val sleepLatencyMinutes: kotlin.Int?,
    @SerialName(value = "deepSleepMinutes") @Required val deepSleepMinutes: kotlin.Int?,
    @SerialName(value = "lightSleepMinutes") @Required val lightSleepMinutes: kotlin.Int?,
    @SerialName(value = "remSleepMinutes") @Required val remSleepMinutes: kotlin.Int?,
