...
fun FoodEditScreen(
    ...
    LaunchedEffect(foodId) {
        if (foodId != null) {
            try {
                ...
                snackbarHostState.showSnackbar("Failed to load food")
    ...
    fun save() {
        ...
        scope.launch {
            try {
                ...
                snackbarHostState.showSnackbar("Failed to save food")
            }
            isSaving = false
        }
    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(if (isEditing) "Edit Food" else "Create Food") },
                navigationIcon = {
